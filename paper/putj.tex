...
\Cref{lrapresults} illustrates the distribution of test-set performance over all splits. 
...
%Because the improvement is not monotonic with respect to the cumulative effects 
%of deformation, it may be that not all deformations are equally useful.
...
This suggests a reduction in the tendency to over-fit the relatively small training sets
...
the reduction in accuracy seen in \Cref{lrapresults}.
...
results are preliminary, and do not yet fully exploit the full capabilities of the
