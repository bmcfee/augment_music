...
annotations moving accordingly~\cite{mauch2013audio}.  Extending this example,
time-dependent annotations such as \emph{tempo} would also have to be adjusted.
...
advantage of JAMS metadata fields to provide data provenance and facilitate
reproducibility.
