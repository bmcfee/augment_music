...
\begin{figure}
    ...
    \caption{Per-class relative change in test-set $F$-score for each augmentation condition,
        relative to no-augmentation ($F_N$).  
        Positive change indicates improvement by training with data augmentation.
        $F$-scores are averaged across test splits.\label{fscore}}
\end{figure}
