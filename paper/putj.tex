...
practitioners to pre-compute several deformations, and later filter the
...
% Input features:
%   CQT at 36 bpo, ranging from C2 to C8 => 216 bins, 512-frame hop at 22KHz
...
we computed the $F$-score of frame-level multi-label
...
such as pitch-shifting can improve model generalization, but that some
