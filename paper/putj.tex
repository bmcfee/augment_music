...
Within the past few years, this same phenomenon of increasing model complexity has been 
...
and identification of label-invariant transformations~\cite{krizhevsky2012imagenet}.
...
representations, recent studies have shown that comparable or better performance can be
achieved with random initialization and fully supervised
training~\cite{glorot2011deep,zeiler2013rectified}.
