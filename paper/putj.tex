...
the 15 most frequently used (by track) instruments, as listed in \Cref{medleytags}.
...
\begin{figure}
    ...
    \caption{Test-set score distributions (mean track-wise label-ranking average precision), aggregated
...
small, but consistent improvement in performance.
