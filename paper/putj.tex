...
in order to achieve invariance to key in estimating chord
quality~\cite{ellis2007classifying}.
...
Similarly, Sturm and Collins proposed the ``Kiki-Bouba Challenge'' as a means to probe
whether statistical models of musical concepts are actually capturing the defining
characteristics of a category, or over-fitting to spurious
...
critical.  The former attempts to measure the robustness of a system in synthetic
conditions, while the latter attempts to provide more robust models, but the evaluation
is outside the control of the experimenter, and relies directly upon the natural
distribution from which samples are drawn.

% TODO: say more about this, tighten it up
