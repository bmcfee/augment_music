...
Next, a generic \emph{annotation} deformation can apply the stretch factor to all
...
appropriate type pattern: in this case, ``\texttt{tempo}''.  Other time-dependent type
